...
suffix = '_sp'
'''
m = Analysis_Neural_Net(run_dir, numModels, variables, standard_vars_idx, modes, data_dir, suffix=suffix)
m.preprocess(raw_data_dir)
m.load_models_and_calculate(mkt=True, disagg=True, social_welfare=True,drive_time_idx=11, drive_cost_idx=13, drive_cost_idx_standard=10, \
...
# market share in the training and testing data
...
avg_vot = np.mean(m.vot_drive_test, axis=1)
