...
def plot_choice_prob(m, plot_modes, plot_vars, plot_vars_standard, plot_var_names, highlight=[], highlightlabel=[]):
...
def plot_prob_derivative(m, plot_modes, plot_vars, plot_vars_standard, plot_var_names, highlight = [], highlightlabel = []):
...
def plot_onemodel_prob_derivative(m, modelNumber, plot_var, plot_vars_standard, plot_var_names):
